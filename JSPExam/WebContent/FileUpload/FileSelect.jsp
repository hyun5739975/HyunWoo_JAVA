...
<%! //선언문 (!)변수나 함수를 정의할때 쓰임
	...
	public String getParam(HttpServletRequest reqeust, 
			String paramName){
	
	if(reqeust.getParameter(paramName) !=  null){
		return reqeust.getParameter(paramName);
	}else{
		return "";
	}
		...
		<table width="75%" border="1" align="center" cellpadding="1"
			...
			<tr bgcolor="#FFCC00">			
				...
				<td width="50%" colspan="3">
					<textarea name="abstract" cols="78"	
...
<table width ="75%" border="1" align="center" bgcolor="#FFFF99"
		cellpadding="1" cellspacing="1" bordercolor="#660000">
